  ...
  return (
    ...
    <div className='h-auto'>  
      ...
      <div className='sm:flex sm:gap-2'>
        ...
        <div className='w-3/5 sm:w-2/5 lg:w-2/5	 xl:w-2/5	2xl:w-2/5'>
            <Image className='sm:w-4/5 lg:w-4/7	 xl:w-2/7		2xl:w-2/7' src="/imgpersonnage1.jpg" width={500} height={500}/>
        </div>
